...
def extract_rider_info_all_pages(
...
process_results(
    "data/mtsa_dhi_me_results_qr.pdf", 26
)  # Note this file has a different table start line
process_results("data/leog_2025_dhi_me_results_q1.pdf", 25)
