...
# process_results("data/leog_dhi_me_results_qr.pdf", 24) # Qualifications
# process_results("data/leog_dhi_me_results_semi.pdf", 25) # Semifinals
process_results("data/vdso_dhi_me_results_qr.pdf", 24) # Qualifications
process_results("data/vdso_dhi_me_results_semi.pdf", 25) # Semifinals